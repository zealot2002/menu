...
public class DateUtils {
    ...
    public static String formatDate(String str) throws ParseException {
        ...
        SimpleDateFormat df2 = new SimpleDateFormat(DateUtils.DATE_FORMAT);
     ...
     * 将时间转换为时间戳
     */
    public static long getStartTime(Calendar calendar) throws ParseException{
    ...
    /*
         * 将时间转换为时间戳
         */
    public static long getEndTime(Calendar calendar) throws ParseException{
